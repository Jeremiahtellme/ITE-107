...
public class PhonebookSystem extends JFrame {
    ...
    private JButton addButton, deleteButton, searchButton, updateButton, displayButton, addGroupButton, deleteGroupButton, calculatePayrollButton;
    private Map<String, java.util.List<Contact>> phonebook;

    private static final String DATA_FILE = "phonebook_data.txt";

    public PhonebookSystem() {
        setTitle("Phonebook System with Groups and Payroll Integration");
    ...
    private JPanel createButtonPanel() {
        ...
        calculatePayrollButton = createStyledButton("Payroll System");
        ...
        calculatePayrollButton.addActionListener(e -> openPayrollSystem());
    ...
    private void displayContacts() {
        contactArea.setText("");
        for (Map.Entry<String, java.util.List<Contact>> entry : phonebook.entrySet()) {
    ...
    private void openPayrollSystem() {
        PayrollSystem payrollSystem = new PayrollSystem(phonebook);
    ...
    static class PayrollSystem extends JFrame {
        ...
        public PayrollSystem(Map<String, List<Contact>> phonebook) {
            ...
            displayEmployeeDetails(phonebook);
        }

        private void displayEmployeeDetails(Map<String, List<Contact>> phonebook) {
            payrollArea.setText("");
            List<Contact> employees = phonebook.get("Employees");
            if (employees != null) {
                for (Contact contact : employees) {
                    payrollArea.append("Employee: " + contact + "\n");
                }
            } else {
                payrollArea.append("No employees found in the phonebook.");
            }
        }
    }
}
